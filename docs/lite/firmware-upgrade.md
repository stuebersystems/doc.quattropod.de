...
Dabei benötigen Sie einen [Internetzugang](connect.wifi.lan.md) zum Internet bzw. mit Ihrem Router.  Wenn der QuattroPod mit Ihrem WLAN verbunden ist, wird eine von Ihrem Netzwerk vergebenen IP-Adressen mit der Bezeichnung `Infrustructure IP` auf dem Bildschirm angezeigt, wie unten abgebildet:
